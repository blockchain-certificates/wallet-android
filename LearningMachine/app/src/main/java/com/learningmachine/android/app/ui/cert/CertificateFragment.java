...
public class CertificateFragment extends LMFragment {
    ...
    private String displayHTML(BlockCert certificate) {
        ...
        String customCss = "body {font-size: 12px; line-height: 1.5; margin:20px; display: inline-block; } body > section { padding:0;} body section { max-width: 100%; } body img { max-width: 100%; height: auto; width: inherit; }";
